...
# local imports
from .utils import get_logger, add_subelement_with_text
from .tags import MessageHeaderTags, MessageControlType, MessagePartyTags
...
class MessageParty:
    ...
    def __init__(self, party_id: str, full_name: str):
    ...
    def write(self) -> et.Element:
        tag: et.Element = et.Element(MessagePartyTags.sender.value)
